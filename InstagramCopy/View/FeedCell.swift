...
//  InstagramCopy
//
//  Created by Elizeu RS on 17/05/19.
...
class FeedCell: UICollectionViewCell {
  ...
  override init(frame: CGRect) {
    ...
    optionsButton.anchor(top: nil, left: nil, bottom: nil, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
